...
namespace AudioPlayer.masterDataSet2TableAdapters {
...
SELECT SongID, Title, Artist, Album, Duration, FilePath FROM Songs WHERE (SongID = @SongID)";
        ...
        public virtual int Fill(masterDataSet2.SongsDataTable dataTable) {
        ...
        public virtual masterDataSet2.SongsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet2.SongsDataTable dataTable = new masterDataSet2.SongsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet2.SongsDataTable dataTable) {
