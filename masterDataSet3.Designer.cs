...
namespace AudioPlayer.masterDataSet3TableAdapters {
...
SELECT SongID, Title, Artist, Album, Duration, FilePath FROM Songs WHERE (SongID = @SongID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AudioPlayer.Properties.Settings.Default.masterConnectionString1;
        }
        ...
        public virtual int Fill(masterDataSet3.SongsDataTable dataTable) {
        ...
        public virtual masterDataSet3.SongsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet3.SongsDataTable dataTable = new masterDataSet3.SongsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet3.SongsDataTable dataTable) {
